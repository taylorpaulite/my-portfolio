        ...
        <div className="flex flex-row justify-between px-12 py-6">
            ...
            <div className="md:block md:justify-right">
                <ul className="hidden list-none md:flex justify-center">
                    ...
                    <li key="resume-btn" className="text-left text-base font-regular text-neutral-800 hover:text-neutral-600 dark:hover:text-neutral-400 dark:text-neutral-200 pl-2 pr-4 pt-2"><a target="_blank" rel="noreferrer" href="https://acrobat.adobe.com/link/home/">Resume</a></li>
                    <Link to={"/contact"}>
